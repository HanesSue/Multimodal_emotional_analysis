...
class VideosProcessor:
    ...
    def process_videos(self, input_path: str, output_dir: str) -> int:
        ...
        for video_path in video_files:
            ...
            command = [
                ...
                "-no2Dvid", "-no3Dvid", "-noMovid", "-nomask"
            ]
    ...
    def extract_and_normalize_features(self, csv_folder: str, output_pkl_path: str) -> Dict[str, Any]:
        """
        ...
        for filename in os.listdir(csv_folder):
            if filename.endswith('.csv'):
                ...
                try:
                    ...
                    if len(features) == 0:
                        print(f"⚠️ No valid frames in {video_id}")
                        continue
...
if __name__ == "__main__":
    # 初始化处理器
    processor = VideosProcessor(openface_exe_path=r"E:\OpenFace_2.2.0_win_x64\OpenFace_2.2.0_win_x64\OpenFace_2.2.0_win_x64\FeatureExtraction.exe")
